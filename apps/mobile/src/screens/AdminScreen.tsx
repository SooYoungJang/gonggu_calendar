...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.surface, borderRadius: borderRadius.xl, padding: spacing.lg, marginBottom: spacing.md, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2, borderWidth: 1, borderColor: colors.border },
  ...
  summary: { color: '#4b5563', fontSize: 14, lineHeight: 20 },
  ...
  badge: { backgroundColor: colors.warningBg, borderRadius: borderRadius.full, color: '#92400e', fontSize: 12, fontWeight: '600', paddingHorizontal: 10, paddingVertical: 4 },
  ...
  secondaryButton: { backgroundColor: '#f3f4f6', paddingVertical: 10, paddingHorizontal: spacing.lg, borderRadius: borderRadius.md, alignSelf: 'flex-start' },
